...
public:
	...
	FMassEntityHandle Projectile(const FVector3f& proj_pos, const FVector3f& dir, float barrel_length, float pressure, const struct FProjectileProperties& properties);
	FMassEntityHandle Projectile(const FVector3f& proj_pos, const FVector3f& dir, float barrel_length, const struct FProjectileProperties& properties, float muzzle_vel);
